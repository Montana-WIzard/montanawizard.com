  ...
  <div class="footer-container">
    <div class="footer-brand-col">
      ...
      <div class="social-row" aria-label="Follow Montana Wizard on social media">
        <a href="https://www.youtube.montanawizard.com" target="_blank" rel="noopener" class="social-link" aria-label="YouTube">
        ...
        <a href="https://www.instagram.montanawizard.com" target="_blank" rel="noopener" class="social-link" aria-label="Instagram">
        ...
        <a href="https://www.facebook.montanawizard.com" target="_blank" rel="noopener" class="social-link" aria-label="Facebook">
        ...
        <a href="https://x.montanawizard.com" target="_blank" rel="noopener" class="social-link" aria-label="X (Twitter)">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
        </a>
        <a href="https://www.tiktok.montanawizard.com" target="_blank" rel="noopener" class="social-link" aria-label="TikTok">
        ...
        <a href="https://www.threads.montanawizard.com" target="_blank" rel="noopener" class="social-link" aria-label="Threads">
